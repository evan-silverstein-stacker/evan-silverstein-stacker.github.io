...
var GameSettings = {
    ...
    //screen
    screenWidthPixels: 1000,
    screenHeightPixels: 500,
    numGridCols: 10,

    //block
    startingSecondsForBlockToCrossScreenWidth: 4,
    percentToIncrementAnimationSpeed: 15,
    percentToIncrementBlockPosition: 0.7,
    blockWidth: 50,
    blockHeight: 50
...
var _Game = __webpack_require__(79);
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'h1',
                    { className: _styles2.default.centerText },
                    ' Stacker '
                ),
                _react2.default.createElement(
                    'h3',
                ...
                _react2.default.createElement(
                    'div',
                    { className: _styles2.default.gameWrapper },
...
var _Stacker = __webpack_require__(80);
...
var _Stats = __webpack_require__(86);
...
var _GameSettings = __webpack_require__(21);
...
var Game = function (_React$Component) {
    ...
    function Game() {
        ...
        _this.state = {
            game: new _Stacker2.default()
        };

        _this.keyPressHandler = _this.keyPressHandler.bind(_this);
        _this.printUpdatedGame = _this.printUpdatedGame.bind(_this);
    ...
    _createClass(Game, [{
        ...
        value: function render() {
            ...
            var barStyle = {
                ...
                height: '5px',
                width: game.screenWidthPixels + 'px',
                bottom: _GameSettings2.default.blockHeight * _GameSettings2.default.maxLayers + "px"
            };

            var blockViewCollection = this.getBlocksComponents(game);
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: _styles2.default.dashWrapper, style: { width: style.width } },
                    _react2.default.createElement(_Stats2.default, { game: game }),
                    _react2.default.createElement(
                        'button',
                        { className: _styles2.default.btn, id: 'startBtn', onClick: function onClick() {
                                _this2.startNewGame();
                            } },
                        ' New Game '
                    )
                ...
                _react2.default.createElement(
                    'div',
                    { className: _styles2.default.screen, id: 'game', style: style },
                    _react2.default.createElement('div', { className: _styles2.default.bar, style: barStyle }),
                    blockViewCollection
                )
            );
        }
    }, {
        key: 'getBlocksComponents',
        value: function getBlocksComponents(game) {
            var blockViewCollection = [];
            for (var i = 0; i < game.blocks.length; i++) {
                var block = game.blocks[i];
                blockViewCollection.push(_react2.default.createElement(_Block2.default, { key: block.id, block: block }));
            }

            if (!game.isGameOver()) {
                blockViewCollection.push(_react2.default.createElement(_Block2.default, { key: game.activeBlock.id, block: game.activeBlock }));
            }
            return blockViewCollection;
        }
    }, {
        key: 'GameResults',
        value: function GameResults(game) {
            if (!game.isGameOver()) {
                return;
            }
            var text = game.lives > 0 ? "you won!" : "you lost!";
            return _react2.default.createElement(
                'div',
                { className: _styles2.default.gameResultText },
                text
            );
        }
    }, {
        ...
        value: function startNewGame() {
            ...
            var game = new _Stacker2.default();
            game.onGameUpdatedCallback = function (game) {
                return _this3.printUpdatedGame(game);
            };
        ...
        key: 'printUpdatedGame',
        value: function printUpdatedGame(game) {
            if (!game.isGameOver()) {
                document.addEventListener('keyup', this.keyPressHandler);
            }
...
function Stacker() {
    ...
    this.screenWidthPixels = _GameSettings2.default.screenWidthPixels;
    this.screenHeightPixels = _GameSettings2.default.screenHeightPixels;
    this.lives = _GameSettings2.default.numLives;
    this.maxLayers = _GameSettings2.default.maxLayers;
    this.grid = initializeGrid(_GameSettings2.default.numGridCols);
    this.blocks = [];
    this.activeBlock = new _Block2.default(this);
    this.currentLayer = 0;
    this.onGameUpdatedCallback = null;

    this.getSecondsForBlockToCrossScreen = function () {
        var time = _GameSettings2.default.startingSecondsForBlockToCrossScreenWidth;
        var speedChange = _GameSettings2.default.percentToIncrementAnimationSpeed / 100 * _this.currentLayer;
        var newTime = time * (1 - speedChange);
        return newTime;
    };

    this.blockWasPlaced = function (block) {
        _this.blocks.push(block);
        _this.currentLayer = getMaxColValue(_this.grid);
        _this.activeBlock = new _Block2.default(_this);
        //if(this.isGameOver()){this.activeBlock = null};

        _this.onGameUpdatedCallback(_this);
    };

    this.nextLayerAttempt = function () {
        if (_this.isGameOver()) {
            return console.log(new Error("game is over"));
        }
        var block = _this.activeBlock;
        snapBlockToGrid(block, _this.screenWidthPixels, _this.grid);
        if (!_this.isLayerCorrectlyPlaced(_this.grid)) {
            _this.lives -= 1;
        };
        _this.activeBlock.setBlockDown();
    };

    this.isLayerCorrectlyPlaced = function (grid) {
        return getMaxColValue(grid) > _this.currentLayer;
    };
    ...
    this.isGameOver = function () {
        ...
        if (_this.currentLayer === _this.maxLayers) {
            return true;
        }
        return false;
    };
...
function snapBlockToGrid(block, screenWidthPixels, grid) {
    var gridCol = null;
    var colwidthPixels = screenWidthPixels / grid.length;
    var blockPixelPosition = block.getLeftPixels();
    var result = blockPixelPosition / colwidthPixels;
    var quotient = Math.floor(result);
    var remainder = result % 1;
    gridCol = quotient; //snap left
    var snapBias = 0.2;
    var cutoff = block.moveDirection === _Direction2.default.right ? snapBias : 1 - snapBias;
    if (remainder > cutoff) {
        gridCol += 1;
    }; // snap right
...
var index = 0; // allows for components to update properly (by setting key)

function Block(game) {
    var _this = this;

    this.id = index++;
    this.getLeftPixels = function () {
        return _this.horizontalPercent / 100 * game.screenWidthPixels;
    };
    this.getTopPixels = function () {
        return _this.verticalPercent / 100 * game.screenHeightPixels;
    };
    this.width = _GameSettings2.default.blockWidth;
    this.height = _GameSettings2.default.blockHeight;

    this.verticalPercent = 2;
    this.horizontalPercent = 0;
    this.interval = null;
    this.isPlaced = false;
    this.moveDirection = _Direction2.default.none;
    this.layersOffset = 0; // this will be set by stacker.js 


    this.getIntervalSeconds = function () {
        var positionChange = _GameSettings2.default.percentToIncrementBlockPosition / 100;
        var time = game.getSecondsForBlockToCrossScreen();
        var result = time * positionChange;
        return time * positionChange;
    };

    this.beginAnimation = function () {
        _this.moveDirection = _Direction2.default.right;
        _this.interval = setInterval(_this.animation, _this.getIntervalSeconds() * 1000);
    };

    this.setBlockDown = function () {
        clearInterval(_this.interval);
        _this.moveDirection = _Direction2.default.down;
        _this.interval = setInterval(_this.animation, 10);
    };

    this.animation = function () {
        _this.setMoveDirection();
        if (_this.moveDirection === _Direction2.default.none) {
            _this.placedBlock();
            return;
        }
        if (_this.moveDirection === _Direction2.default.left || _this.moveDirection === _Direction2.default.right) {
            _this.changeHorizontalPosition();
        } else {
            _this.changeVerticalPosition();
        }

        _this.onPositionChangedCallback();
    };

    this.changeHorizontalPosition = function () {
        var quality = 1;
        if (_this.moveDirection === _Direction2.default.left) {
            quality = -1;
        }
        _this.horizontalPercent = _this.horizontalPercent + _GameSettings2.default.percentToIncrementBlockPosition * quality;
    };

    this.changeVerticalPosition = function () {
        var quality = 1;
        if (_this.moveDirection === _Direction2.default.up) {
            quality = -1;
        }
        _this.verticalPercent = _this.verticalPercent + 1 * quality;
    };

    this.snapToGrid = function (horizontalPercent) {
        _this.horizontalPercent = horizontalPercent * 100;
        _this.onPositionChangedCallback();
    };

    this.setMoveDirection = function () {
        if (_this.moveDirection === _Direction2.default.left && _this.horizontalPercent <= 0) {
            _this.moveDirection = _Direction2.default.right;
        } else if (_this.moveDirection === _Direction2.default.right && _this.horizontalPercent >= 100 - _this.width / _GameSettings2.default.screenWidthPixels * 100) {
            _this.moveDirection = _Direction2.default.left;
        } else if (_this.moveDirection === _Direction2.default.up && _this.verticalPercent <= 0) {
            _this.moveDirection = _Direction2.default.down;
        } else if (_this.moveDirection === _Direction2.default.down && _this.verticalPercent >= 100 - (_this.height + _this.layersOffset) / _GameSettings2.default.screenHeightPixels * 100) {
            _this.moveDirection = _Direction2.default.none;
        }
    };

    this.placedBlock = function () {
        _this.isPlaced = true;
        clearInterval(_this.interval);
        game.blockWasPlaced(_this);
        _this.snapToBottom();
    };

    this.snapToBottom = function () {
        _this.verticalPercent = 100 - (_this.height + _this.layersOffset) / _GameSettings2.default.screenHeightPixels * 100;
        _this.onPositionChangedCallback();
    };
}
...
var Block = function (_React$Component) {
    ...
    _createClass(Block, [{
        ...
        value: function componentDidMount() {
            ...
            block.onPositionChangedCallback = function () {
        ...
        value: function render() {
            var block = this.props.block;
            var borderOffset = 1 * 2; // styles.css (doubled for border on each side)
            var style = {
                position: 'absolute',
            ...
            };return _react2.default.createElement('div', { className: _styles2.default.block, style: style });
        }
    }]);
...
// module
exports.push([module.i, ".styles__block___1Y_GL{\r\n    border: 1px solid white;\r\n    background-color: turquoise;\r\n}", ""]);

// exports
exports.locals = {
	"block": "styles__block___1Y_GL"
};
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    null,
                    " Layers completed: ",
                    game.currentLayer + "\/" + game.maxLayers,
                    " "
                )
            );
        }
...
// module
exports.push([module.i, ".styles__dashWrapper___1ADZh{\r\n    margin: auto;\r\n    display: flex;\r\n    flex-wrap: wrap;\r\n    justify-content: space-between;\r\n    margin-bottom: 10px;\r\n}\r\n\r\n.styles__screenWrapper___3LAUq{\r\n    border: 5px solid goldenrod;\r\n}\r\n\r\n.styles__screen___2rjL1{\r\n    background-color: black;\r\n    margin: auto;\r\n}\r\n\r\n\r\n.styles__btn___hheXX{\r\n\r\n}\r\n\r\n.styles__gameResultText___1t7V9{\r\n    text-align: center;\r\n    font-size: 1.2rem;\r\n}\r\n\r\n.styles__bar___k4Ced{\r\n    background-color: darkslategray\r\n}", ""]);

// exports
exports.locals = {
	"dashWrapper": "styles__dashWrapper___1ADZh",
	"screenWrapper": "styles__screenWrapper___3LAUq",
	"screen": "styles__screen___2rjL1",
	"btn": "styles__btn___hheXX",
	"gameResultText": "styles__gameResultText___1t7V9",
	"bar": "styles__bar___k4Ced"
};
...
// module
exports.push([module.i, "body{\r\n    margin: 0px !important;\r\n    background-color: powderblue;\r\n    padding: 20px;\r\n}\r\n\r\n.styles__centerText___30O4j{\r\n    text-align: center;\r\n}\r\n\r\n.styles__gameWrapper___1-24Y{\r\n    margin: 40px;\r\n}\r\n\r\n\r\n\r\n\r\n", ""]);

// exports
exports.locals = {
	"centerText": "styles__centerText___30O4j",
	"gameWrapper": "styles__gameWrapper___1-24Y"
};
